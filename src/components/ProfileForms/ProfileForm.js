...
import { createProfile, getCurrentProfile, uploadProfileImage } from "../../redux/modules/profiles";
    ...
    return(
        <div className="main" style={{width: 600, textAlign: "center"}}>
            ...
            <form className="form1" onSubmit={onSubmit}>
                ...
                <div className="form-group">
                    <input type="text" placeholder="Company" name="company" value={company} onChange={onChange}></input>
                </div>
                <div className="form-group">
                    <input type="text" placeholder="Website" name="website" value={website} onChange={onChange}></input>
                </div>
                <div className="form-group">
                    <input type="text" placeholder="Location" name="location" value={location} onChange={onChange}></input>
                </div>
                <div className="form-group">
                    <input type="text" placeholder="Country" name="country" value={country} onChange={onChange}></input>
                </div>
                <div className="form-group">
                    <input type="text" placeholder="Skills" name="skills" value={skills} onChange={onChange}></input>
                </div>
                <div className="form-group">
                    <textarea placeholder="Short bio about yourself" name="bio" value={bio} onChange={onChange}></textarea>
                </div>
                ...
                <Fragment>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="github URL" name="github" value={github} onChange={onChange}/>
                    </div>
                </Fragment>) : <Fragment/>}
